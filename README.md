...
## Kurzfassung
- Eingabe: CSV (Semikolon) mit Spender:innen-Daten
...
```
Nachname;Vorname;Straße;PLZ Ort;Adresszusatz;Betrag;Spendendatum
```
### Beispiel:
```
Mustermensch;Muster;Musterstr. 1;10000 Musterstadt;c/o Musterfirma;50,00;01.01.2025
...
## Lizenz & Haftung
Dieses Script ist ein Hilfsmittel. Die Verantwortung für inhaltliche und rechtliche Richtigkeit der Bescheinigungen liegt bei den Aussteller:innen.